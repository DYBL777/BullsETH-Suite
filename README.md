...
OG principal first. Committed capital returned to upfront OGs.
Casual final-draw tickets second. Most recent participants refunded their last draw cost.
Pro-rata surplus third. Remaining pot distributed proportionally to all recent participants, where the pot allows.
Treasury last. Any residual after all player obligations.
